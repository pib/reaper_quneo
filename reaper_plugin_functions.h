...
// Create a new MIDI media item, containing no MIDI events.
  ...
  MediaItem* (*CreateNewMIDIItemInProj)(MediaTrack* track, double starttime, double endtime);
#endif
...
// For the main action context, the MIDI editor, or the media explorer, returns the toggle state of the action. 0=off, 1=on, -1=NA because the action does not have on/off states.  For the MIDI editor, the action state for the most recently focused window will be returned.
  ...
  int (*GetToggleCommandState2)(KbdSectionInfo* section, int cmdID);
#endif
...
// GetToggleCommandStateThroughHooks
  ...
  int (*GetToggleCommandStateThroughHooks)(KbdSectionInfo* sec, int command_id);
#endif
...
// Insert a new MIDI event.
  ...
  bool (*MIDI_InsertEvt)(MediaItem_Take* take, bool selected, bool muted, double ppqpos, const char* msg, int msg_sz);
#endif
...
// Insert a new MIDI note.
  ...
  bool (*MIDI_InsertNote)(MediaItem_Take* take, bool selected, bool muted, double startppqpos, double endppqpos, int chan, int pitch, int vel);
#endif
...
// Insert a new MIDI text or sysex event. Allowable types are -1:sysex (msg should include bounding F0..F7), 1-7:MIDI text event types.
  ...
  bool (*MIDI_InsertTextSysexEvt)(MediaItem_Take* take, bool selected, bool muted, double ppqpos, int type, const char* msg, int msg_sz);
#endif
...
// Set MIDI event properties. Properties passed as NULL will not be set.
  ...
  bool (*MIDI_SetEvt)(MediaItem_Take* take, int evtidx, const bool* selectedInOptional, const bool* mutedInOptional, const double* ppqposInOptional, const char* msgOptional, int msgOptional_sz);
#endif
...
// Set MIDI note properties. Properties passed as NULL will not be set.
  ...
  bool (*MIDI_SetNote)(MediaItem_Take* take, int noteidx, const bool* selectedInOptional, const bool* mutedInOptional, const double* startppqposInOptional, const double* endppqposInOptional, const int* chanInOptional, const int* pitchInOptional, const int* velInOptional);
#endif
...
// Set MIDI text or sysex event properties. Properties passed as NULL will not be set. Allowable types are -1:sysex (msg should not include bounding F0..F7), 1-7:MIDI text event types.
  ...
  bool (*MIDI_SetTextSysexEvt)(MediaItem_Take* take, int textsyxevtidx, const bool* selectedInOptional, const bool* mutedInOptional, const double* ppqposInOptional, const int* typeInOptional, const char* msgOptional, int msgOptional_sz);
#endif
...
// See MIDIEditor_GetActive, MIDIEditor_GetSetting_str
  ...
  int (*MIDIEditor_GetSetting_int)(void* midieditor, const char* setting_desc);
#endif
...
// See MIDIEditor_GetActive, MIDIEditor_GetSetting_int
  ...
  bool (*MIDIEditor_GetSetting_str)(void* midieditor, const char* setting_desc, char* buf, int buf_sz);
#endif
...
// get the take that is currently being edited in this MIDI editor
  ...
  MediaItem_Take* (*MIDIEditor_GetTake)(void* midieditor);
#endif
...
// see MIDIEditor_GetActive, MIDIEditor_LastFocused_OnCommand
  ...
  bool (*MIDIEditor_OnCommand)(void* midieditor, int command_id);
#endif
...
// get the named command for command ID number. the returned string won't start with '_' (e.g. it will return "SWS_ABOUT" for the SWS about box action), it will be NULL if cmd is a native action.
  ...
  const char* (*ReverseNamedCommandLookup)(int cmd);
#endif
...
// You must use this to change the focus programmatically. mode=0 to focus track panels, 1 to focus the arrange window, 2 to focus the arrange window and select env (or env==NULL to clear the current track/take envelope selection)
  ...
  void (*SetCursorContext)(int mode, void* env);
#endif
...
// convert a beat position (or optionally a beats+measures if measures is non-NULL) to time.
  ...
  double (*TimeMap2_beatsToTime)(ReaProject* proj, double tpos, int* measuresOutOptional);
#endif
